...
#output: tracking/ByteTrack_analysis , _summary.csv , .txt file for each video, formatted for the MOT (Multiple Object Tracking) benchmark
import pandas as pd
import numpy as np
...
output_dir = Path("tracking/ByteTrack_analysis")
